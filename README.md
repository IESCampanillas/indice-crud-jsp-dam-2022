# CRUD con JSP y MySQL - Curso 2021 / 2022
...
Cada alumno debe editar este `README.md` y añadir sus apellidos, su nombre (por orden alfabético), el título del CRUD y un enlace al repositorio de la aplicación.
...
## Plazos de entrega y presentación
